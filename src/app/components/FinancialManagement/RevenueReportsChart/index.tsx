...
export const RevenueRepotsChart = (): React.ReactElement => {
  return (
    <div className="overflow-hidden overflow-x-scroll mt-10">
      <div className="min-w-[600px] w-full h-[374px] border-2 border-boxOutline  pr-6 pb-6 pt-3 pl-0 bg-bgBox rounded-xl overflow-hidden overflow-x-auto ">
        ...
        <ResponsiveContainer width={"100%"} height="80%">
          <LineChart
            ...
            height={100}
            data={data}
            margin={{ top: 10, left: 40, right: 10, bottom: 40 }}
          >
