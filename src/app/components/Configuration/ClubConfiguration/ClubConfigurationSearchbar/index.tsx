  ...
  return (
    <div>
      ...
      <div className="flex flex-col sm:flex-row items-center gap-y-4 sm:gap-y-0 gap-x-6 mt-4 sm:mt-6">
        <div className="flex items-center h-[49px] border-2 border-boxOutline w-full bg-bgBox rounded-xl px-3">
          <MImage
        ...
        <PrimaryButton
          title="Search"
          className="sm:w-[126px] !h-[44px] rounded-full bg-PrimaryColor"
        />
      </div>
    </div>
  );
